  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-900">Posting Coverage Dashboard</h2>
          <p className="text-slate-500 text-sm italic">"A task is not done until it is brief-compliant and QA-complete."</p>
        </div>
        <div className="flex gap-4">
          <div className="text-right">
             <p className="data-label text-[var(--accent)] font-bold">Total Target</p>
             <p className="text-2xl font-bold font-mono">100</p>
          </div>
          <div className="text-right border-l border-slate-200 pl-4">
             <p className="data-label text-[var(--success)] font-bold">Received</p>
             <p className="text-2xl font-bold font-mono">68</p>
          </div>
          <div className="text-right border-l border-slate-200 pl-4">
             <p className="data-label text-[var(--critical)] font-bold">Missing</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={kpi.label} className="command-card p-4 flex items-center gap-4">
      ...
      <div className="command-card">
        <div className="p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
          ...
          <div className="flex gap-2">
            <span className="stage-tag bg-red-100 text-red-700">3 Critically Missing</span>
          </div>
        </div>
